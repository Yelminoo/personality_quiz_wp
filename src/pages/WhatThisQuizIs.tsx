    ...
    <div className="bg-white">
      <div className="max-w-6xl mx-auto px-4 py-8 text-gray-800 leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-4xl mb-6 text-pantone-276c font-light border-b-2 border-soft-gold pb-2">Why Take It</h2>
          <ul className="list-none p-0 space-y-3">
            <li className="bg-gray-50 p-4 rounded-lg border-l-4 border-soft-gold text-lg shadow-sm">
      ...
      <section className="mb-12">
        <h2 className="text-4xl mb-6 text-pantone-276c font-light border-b-2 border-soft-gold pb-2">How It Works (3 Simple Steps)</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          <div className="flex items-start bg-white p-8 rounded-xl shadow-lg hover:transform hover:-translate-y-2 transition-transform duration-300">
            <div className="bg-soft-gold text-white w-10 h-10 rounded-full flex items-center justify-center font-bold mr-4 flex-shrink-0">
              1
            </div>
            <div>
              <h3 className="text-xl font-semibold text-pantone-276c mb-2">Answer Questions</h3>
          ...
          <div className="flex items-start bg-white p-8 rounded-xl shadow-lg hover:transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <div>
              <h3 className="text-xl font-semibold text-pantone-276c mb-2">Get Mapped</h3>
          ...
          <div className="flex items-start bg-white p-8 rounded-xl shadow-lg hover:transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <div>
              <h3 className="text-xl font-semibold text-pantone-276c mb-2">Receive Your Symbols</h3>
      ...
      <section className="mb-12">
        <h2 className="text-4xl mb-6 text-pantone-276c font-light border-b-2 border-soft-gold pb-2">What You'll Receive</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          <div className="bg-white p-6 rounded-lg text-center border-t-4 border-soft-gold shadow-sm">
            <h4 className="text-lg font-semibold text-pantone-276c mb-2">Theme Name</h4>
            <p className="text-gray-600">That reflects your current journey</p>
          </div>
          <div className="bg-white p-6 rounded-lg text-center border-t-4 border-soft-gold shadow-sm">
            <h4 className="text-lg font-semibold text-pantone-276c mb-2">3–5 Symbols</h4>
            <p className="text-gray-600">Matched to you (e.g., Courage, Trust, Vision)</p>
          </div>
          <div className="bg-white p-6 rounded-lg text-center border-t-4 border-soft-gold shadow-sm">
            <h4 className="text-lg font-semibold text-pantone-276c mb-2">Symbol Meanings</h4>
            <p className="text-gray-600">Of each symbol in simple language</p>
          </div>
          <div className="bg-white p-6 rounded-lg text-center border-t-4 border-soft-gold shadow-sm">
            <h4 className="text-lg font-semibold text-pantone-276c mb-2">Shape Suggestions</h4>
            <p className="text-gray-600">Triangle, spiral, shield, etc. you can translate into design</p>
          </div>
          <div className="bg-white p-6 rounded-lg text-center border-t-4 border-soft-gold shadow-sm">
            <h4 className="text-lg font-semibold text-pantone-276c mb-2">Styling Hints</h4>
            <p className="text-gray-600">Geometric, round, spiral, sharp, nature-inspired</p>
          </div>
          <div className="bg-white p-6 rounded-lg text-center border-t-4 border-soft-gold shadow-sm">
            <h4 className="text-lg font-semibold text-pantone-276c mb-2">Next Steps</h4>
      ...
      <section className="mb-12">
        <h2 className="text-4xl mb-6 text-pantone-276c font-light border-b-2 border-soft-gold pb-2">Who It's For</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <div className="bg-soft-gold text-white p-6 rounded-lg text-center shadow-lg">
      ...
      <section className="mb-12">
        <h2 className="text-4xl mb-6 text-pantone-276c font-light border-b-2 border-soft-gold pb-2">What Makes NobArt Different</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
          <div className="bg-white p-8 rounded-lg shadow-md text-center border-t-4 border-pantone-276c">
            <h4 className="text-xl font-semibold text-pantone-276c mb-4">Symbolic System</h4>
            <p className="text-gray-600">50+ core symbols with clear meanings and shapes.</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md text-center border-t-4 border-pantone-276c">
            <h4 className="text-xl font-semibold text-pantone-276c mb-4">Modular Design</h4>
            <p className="text-gray-600">Pieces can combine multiple symbols into one story.</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md text-center border-t-4 border-pantone-276c">
            <h4 className="text-xl font-semibold text-pantone-276c mb-4">Craft + Tech</h4>
            <p className="text-gray-600">Human craftsmanship guided by a structured, unbiased quiz.</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md text-center border-t-4 border-pantone-276c">
            <h4 className="text-xl font-semibold text-pantone-276c mb-4">Timeless Design</h4>
      ...
      <section className="mb-12">
        <h2 className="text-4xl mb-6 text-pantone-276c font-light border-b-2 border-soft-gold pb-2">Example Result (What Visitors See)</h2>
        <div className="bg-pantone-276c text-white p-8 rounded-xl mt-8">
          <h3 className="text-3xl mb-4 text-soft-gold">Your Theme: Strategic Builder</h3>
          ...
          <div className="mb-6 space-y-2">
            <div className="py-2 border-b border-soft-gold border-opacity-30 last:border-b-0">
              <strong>Strategy</strong> — plan your moves <span className="text-gray-300 italic">(shape: chessboard square)</span>
            </div>
            <div className="py-2 border-b border-soft-gold border-opacity-30 last:border-b-0">
              <strong>Manifestation</strong> — refine vision into matter <span className="text-gray-300 italic">(shape: diamond/pyramid)</span>
            </div>
            <div className="py-2 border-b border-soft-gold border-opacity-30 last:border-b-0">
              <strong>Discipline</strong> — build structure and rhythm <span className="text-gray-300 italic">(shape: rectangle)</span>
            </div>
            <div className="py-2 border-b border-soft-gold border-opacity-30 last:border-b-0">
              <strong>Focus</strong> — one aim, one path <span className="text-gray-300 italic">(shape: target)</span>
            </div>
          </div>
          
          <p className="bg-pantone-276c-light p-4 rounded-md">
      ...
      <section className="mb-12">
        <h2 className="text-4xl mb-6 text-pantone-276c font-light border-b-2 border-soft-gold pb-2">Time & Privacy</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          <div className="bg-white p-8 rounded-lg text-center shadow-sm border border-soft-gold border-opacity-20">
            <h4 className="text-xl font-semibold text-pantone-276c mb-4">Time to Complete</h4>
            <p className="text-gray-600">2–3 minutes</p>
          </div>
          <div className="bg-white p-8 rounded-lg text-center shadow-sm border border-soft-gold border-opacity-20">
            <h4 className="text-xl font-semibold text-pantone-276c mb-4">Privacy</h4>
      ...
      <section className="mb-12">
        <h2 className="text-4xl mb-6 text-pantone-276c font-light border-b-2 border-soft-gold pb-2">After the Quiz</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-soft-gold">
            <h4 className="text-lg font-semibold text-pantone-276c mb-4">Design Your Talisman</h4>
            <p className="text-gray-600">Work with us to translate your symbols into a custom ring, pendant, bracelet, or earrings.</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-soft-gold">
            <h4 className="text-lg font-semibold text-pantone-276c mb-4">Save Your Reading</h4>
            <p className="text-gray-600">Print or receive a PDF of your symbols.</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-soft-gold">
            <h4 className="text-lg font-semibold text-pantone-276c mb-4">Explore More</h4>
      ...
      {/* FAQ Section */}
      <section className="mb-12">
        <div className="bg-white rounded-lg shadow-md border-l-4 border-soft-gold overflow-hidden">
          <button
            onClick={toggleFaq}
            className="w-full p-6 text-left hover:bg-soft-gold hover:bg-opacity-10 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-soft-gold focus:ring-inset"
          >
            <div className="flex justify-between items-center">
              <h2 className="text-4xl text-pantone-276c font-light">FAQ</h2>
              <svg
                className={`w-6 h-6 text-soft-gold transform transition-transform duration-200 ${
          ...
          >
            <div className="px-6 pb-6 space-y-6">
              {faqData.map((faq, index) => (
                <div key={index} className="border-b border-soft-gold border-opacity-20 last:border-b-0 pb-4 last:pb-0">
                  <h4 className="text-lg font-semibold text-pantone-276c mb-3">{faq.question}</h4>
